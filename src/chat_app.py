...
# Use API key if available, otherwise use DefaultAzureCredential with token provider
gpt_api_key = validated_env_vars.get("gpt_api_key")
if gpt_api_key:
    llm_client = AzureOpenAI(
        azure_endpoint=validated_env_vars["gpt_endpoint"],
        api_key=gpt_api_key,
        api_version=validated_env_vars["gpt_api_version"],
    )
else:
