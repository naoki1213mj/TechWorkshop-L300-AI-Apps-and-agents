...
SHOPPER_PROMPT_TARGET = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
    "prompts",
    "ShopperAgentPrompt.txt",
)
with open(SHOPPER_PROMPT_TARGET, "r", encoding="utf-8") as file:
    SHOPPER_PROMPT = file.read()
...
functions = create_function_tool_for_agent("shopper")
toolset = ToolSet()
